...
namespace ApiCatalogoJogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        private static Dictionary<Guid, Jogo> jogos = new Dictionary<Guid, Jogo>()
        {
            ...
            { Guid.Parse("Se99c84a-108b-4dfa-ab7e-d8c55957a7ec"), new Jogo{ Id = Guid.Parse("Se99c84a-108b-4dfa-ab7e-d8c55957a7ec"),  Nome = "Fifa 19", Produtora = "EA", Preco = 180 } },
        ...
        public Task Atulizar(Jogo jogo)
        {
            jogos[jogo.Id] = jogo;
            return Task.CompletedTask;
        }
